      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[9px] bg-slate-50 px-2 py-0.5 rounded border border-slate-200 text-sports-gray font-bold uppercase tracking-wider">
              {sportType}
            </span>
      ...
      <div className="shrink-0 flex items-center gap-2">
        {actionButton ? (
          ...
          <Link
            ...
            className="w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-100 border border-slate-300 flex items-center justify-center text-sports-gray hover:text-slate-900 transition"
          >
