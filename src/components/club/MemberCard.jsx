    ...
    <div className="glass-card border-slate-200 rounded-2xl p-5 hover:border-slate-300 transition duration-300 flex items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        <img
          ...
          alt={name}
          className="w-11 h-11 rounded-full border border-slate-300 bg-slate-50 object-cover shrink-0"
        />
        <div className="truncate">
          <h4 className="text-sm font-bold text-slate-900 truncate max-w-[150px]">{name}</h4>
      ...
      <div className="flex items-center gap-4 text-right shrink-0">
        <div className="px-2">
          ...
          <span className="text-sm font-extrabold text-slate-900">{predictions}</span>
        </div>
