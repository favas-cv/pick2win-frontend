    ...
    <div className="space-y-6">
      ...
      <div className="text-center text-xs space-y-2">
        <p className="text-sports-gray">
          ...
          <Link to="/login/user" className="text-blue-600 hover:underline font-bold">User login</Link>
        </p>
        <p className="text-sports-gray">
          Want to open a club?{' '}
          <Link to="/register/owner" className="text-blue-600 hover:underline font-bold">Register as Owner</Link>
        </p>
      </div>
    </div>
  );
